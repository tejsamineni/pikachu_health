...
from .calculate_bmi import CalculateBMI
from .recommend_water_intake import RecommendWaterIntake
from .general_health_tips import GeneralHealthTips
...
def load_tools(name: str) -> BaseTool:
    name2tool = {
        ...
        "recommend_water_intake": RecommendWaterIntake,
        "general_health_tips": GeneralHealthTips,
